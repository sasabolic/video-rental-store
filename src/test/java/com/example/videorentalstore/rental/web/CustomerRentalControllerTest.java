...
public class CustomerRentalControllerTest {
    ...
    public void whenReturnBackForNonExistingCustomerThenReturnStatusNotFound() throws Exception {
        ...
        given(rentalService.returnBack(isA(ReturnRentalsCommand.class))).willThrow(new CustomerNotFoundException(message));
    ...
    public void whenReturnBackForCustomerNonExistingRentalsThenReturnStatusBadRequest() throws Exception {
        ...
        given(rentalService.returnBack(isA(ReturnRentalsCommand.class))).willThrow(new RentalException(message, Arrays.asList(new RentalNotFoundException(message1), new RentalNotFoundException(message2))));
